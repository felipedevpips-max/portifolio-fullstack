  ...
  res.json([
    {
      ...
      description:
        "Portfólio completo desenvolvido com React no frontend e Node.js/Express no backend, exibindo projetos, habilidades e informações de contato em tempo real. Inclui design responsivo, animações suaves e formulários funcionais que demonstram práticas reais de desenvolvimento full‑stack.",
      techs: ["React", "JavaScript", "Node", "Express", "Docker"],
      github: "https://github.com/felipedevpips-max/portifolio-fullstack",
      deploy: "https://portifolio-stack.web.app/",
    ...
    },
    {
      ...
      title: "The Myhtz",
      description:
        "Website institucional desenvolvido para a banda The Mythz, com foco em presença digital, divulgação e marketing, ao mesmo tempo em que serviu como um projeto prático para evolução das minhas habilidades em desenvolvimento front-end.",
    ...
    },
    {
      ...
      deploy:
        "https://cookin-up-3as1-2cumbfutl-felipes-projects-17fecd7b.vercel.app/",
      image: "cookinup.png",
    },
    {
      id: 4,
      title: "To Do List",
      description:
        "Aplicação de lista de tarefas desenvolvida com React e JavaScript, permitindo ao usuário criar, marcar como concluída e excluir tarefas. O projeto foi criado com o objetivo de praticar conceitos essenciais do desenvolvimento front-end moderno.",
    ...
    },
    {
      ...
      description:
        "Aplicação que integra um timer Pomodoro com um gerenciador de tarefas (CRUD). As tarefas são salvas no LocalStorage e são marcadas como concluídas automaticamente ao final de um ciclo de foco. O projeto foi desenvolvido com o objetivo de praticar conceitos essenciais do desenvolvimento front-end moderno.",
      techs: ["JavaScript"],
